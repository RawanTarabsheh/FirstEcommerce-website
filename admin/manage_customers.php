...
<div class="main-content">
	...
	if(isset($_POST['submit']))
	{
		...
		$query="UPDATE customers SET customer_name       ='$customerName',
			...
			echo '<script >
		          alert("Please Uploaded Custmore Image");
	              </script>';
		}	
	}//end if submit
	if(isset($_GET['idd'])){
							...
							<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
								...
								<div class="row form-group">
									...
									<div class="col-12 col-md-9">
										...
										<img src="images/customers/<?php echo $customers['customer_image'] ;?>" style="width: 200px; height: 150px;" >
									    <?php } ?>
...
?>
									<tr class="tr-shadow">
										...
										<td  style="padding: 10px;"><?php echo $autonumber;?></td>
										...
										<td style="padding: 10px;"><img
										 ...
										 class="w-25 img-fluid rounded" style="width:75px; height:75px;"></td>
										<td style="padding:25px;"><?php echo $customers['last_login'];?></td>
										<td  style="padding:10px;">
