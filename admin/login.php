...
session_start();
	...
	if(isset($_POST['submit']))
	{
        ...
        {
        	$admin=mysqli_fetch_assoc($login);
        	 if(isset($_POST['remember'])) {
                $_SESSION['remmeber_id']=$admin['admin_id'];
                        ...
                        <div class="login-form">
                            ...
                            <form action="" method="post">
                                <div class="form-group">
                                   ...
                                   {
                                    $query1="SELECT * FROM admin WHERE admin_id={$_SESSION['remmeber_id']}";
                                    $remember=mysqli_fetch_assoc(mysqli_query($conn,$query1));
                                    $email=$remember['admin_email'];
                                    $password=md5($remember['admin_password']);
                                   }
                                   else
                                   {
                                     $email="";
...
<?php include_once('include/admin_footer.php'); ?><!DOCTYPE html>
<html lang="en">
