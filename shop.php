 ...
 if(isset($_GET['id']))
      {
        ...
        if(isset($_GET['n']))
      	...
      	$cat_id=$_GET['id'];
      	$query="SELECT * FROM products INNER JOIN category ON products.cat_id = category.cat_id WHERE products.cat_id={$cat_id}  ";
                            ...
                            <div class="col-12">
                                <div class="product-topbar d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="total-products">
                                        <p><span><?php echo $numberofproducts; ?></span> products found</p>
                                    </div>
                                    <!-- Sorting -->
...
?>
                    ...
                    <nav aria-label="navigation">
                        <ul class="pagination mt-50 mb-70">
                            ...
                            <li class="page-item"><a class="page-link" href="shop.php?n=1">1</a></li>
                            <li class="page-item"><a class="page-link" href="shop.php?n=2">2</a></li>
                            <li class="page-item"><a class="page-link" href="shop.php?n=3">3</a></li>
                            <li class="page-item"><a class="page-link" href="shop.php?n=5">...</a></li>
                            <li class="page-item"><a class="page-link" href="shop.php?n=6">21</a></li>
